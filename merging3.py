    ...
    try:
        while running:
            ...
            if current_app_state == homepage:
                ...
                # update rolling arrays with the new values (it shifts the oldest value out in the buffer earlier function)
                ...
                #need the average of gyro x, y and z
                avg_gyro = np.mean(gyro_buffer, axis=0)
                #need the average of accel x and y
