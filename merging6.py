...
def update_buffer_rolling_avg(buffer, new_val):
    ...
    return np.mean(buffer, axis=0), True
    ...
    try:
        while running:
            ...
            if current_app_state == homepage:
                ...
                avg_gyro, gyro_valid = update_buffer_rolling_avg(gyro_buffer, gyro)
                avg_accel, accel_valid = update_buffer_rolling_avg(accel_buffer, accel)
